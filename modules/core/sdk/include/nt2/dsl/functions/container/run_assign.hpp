...
//==============================================================================
#ifndef NT2_DSL_FUNCTIONS_CONTAINER_RUN_ASSIGN_HPP_INCLUDED
#define NT2_DSL_FUNCTIONS_CONTAINER_RUN_ASSIGN_HPP_INCLUDED

#include <nt2/dsl/functions/run_assign.hpp>
...
namespace nt2 { namespace ext
{
  ...
  NT2_FUNCTOR_IMPLEMENTATION( nt2::tag::run_assign_, tag::cpu_
                            , (A0)(T0)
                            , ((node_ < A0
                                      , elementwise_<T0>, boost::mpl::long_<0>
                                      , nt2::container::domain
                                      >
                              ))
                              ((node_ < A0
